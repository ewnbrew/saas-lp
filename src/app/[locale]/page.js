  ...
  const featureMatrix = [
    {
      ...
      icon: FiBookOpen,
      description:
        t("section-second.points.first.description"),
    },
    {
    ...
    },
    {
      ...
      icon: FiShoppingBag,
      description:
        t("section-second.points.third.description"),
    },
    {
	  ...
	  return (
	    <div className="min-h-screen bg-white text-[#0f172a]">
	      ...
	      <main className="space-y-16">
	        <section className="relative w-full px-6 sm:px-10 pt-16 lg:pt-20 pb-16 min-h-[100dvh] lg:h-screen flex items-center overflow-x-hidden bg-gradient-to-br from-[#e0f2fe] via-white to-[#e0fcef]">
	          <div
	            aria-hidden="true"
          ...
          />
	          <div data-reveal className="reveal relative z-10 mx-auto grid w-full max-w-6xl gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center">
          ...
          <section id="benefits" className="grid pb-16 pt-10 gap-6 lg:grid-cols-12 items-start">
            <div id="features" className="lg:col-span-12">
                ...
                <div className="mb-5">
	                ...
	                {featureMatrix.map((feature, index) => {
	                  ...
	                  return (
	                    <div
	                      key={feature.title}
	                      data-reveal
	                      className={`reveal group isolate relative overflow-hidden cursor-pointer rounded-2xl border bg-gradient-to-br from-white via-white to-[#e0f2fe] p-8 shadow-sm backdrop-blur transition will-change-transform hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-200/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/40 ${
	                        isSelected
	                          ? "border-blue-600 ring-2 ring-blue-600/25"
	                          : "border-blue-100/80 hover:border-blue-200/90"
	                    ...
	                    >
	                      <div className="relative z-10 flex flex-col gap-3">
	                        <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-50 via-white to-emerald-50 text-[#1d4ed8] shadow-sm ring-1 ring-blue-100">
                        ...
                        <p className="text-2xl font-semibold text-[#0f172a]">
	                      ...
	                      {feature.description && (
	                        <p className="relative z-10 mt-3 text-lg text-slate-600">
	                          {feature.description}
	                        </p>
	                      )}
	              ...
	              <div data-reveal className="reveal flex justify-center items-center gap-3 mt-10" style={{ transitionDelay: "180ms" }}>
	                <a href="#" className="flex items-center gap-2 rounded-full bg-[#2563eb] px-6 py-3 text-lg sm:text-base font-semibold text-white shadow-[0_12px_32px_-16px_rgba(37,99,235,0.7)] hover:-translate-y-0.5 transition">

...
export default function Home() {
  ...
  const featureMatrix = [
    { title: "Untuk Siapa", description: "Restoran yang mengelola reservasi melalui WhatsApp, buku catatan/kertas, ponsel manajer, Google Calendar atau catatan sederhana.", icon: FiBookOpen },
    { title: "Cara kerja", description: "Automated table requests and calendar management.", icon: FiCalendar },
    { title: "Kontrol di tangan restoran", description: "Seamless handoff for orders or secure payment links.", icon: FiShoppingBag },
    { title: "Apa yang BUKAN", description: "Real-time delivery and order tracking notifications.", icon: FiBell },
    { title: "Kepercayaan lokal", description: "Instant answers for location, hours, promos, and policies.", icon: FiGlobe },
  ];
